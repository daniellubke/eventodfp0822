		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#brcomdfpeventodfp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomdfpeventodfp-display": {
								"semanticObject": "brcomdfpeventodfp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.dfp.eventodfp",
									"url": sap.ui.require.toUrl("br/com/dfp/eventodfp")
								}
							}
						}
					}
